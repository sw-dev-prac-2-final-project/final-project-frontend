...
export default function RegisterClient({ callbackUrl }: RegisterClientProps) {
          ...
          <div className="flex items-center gap-6">
            <label className="inline-flex items-center gap-2 text-sm font-normal text-primary-color-muted">
              <input
                ...
                onChange={(event) =>
                  updateField("role", event.target.value as "staff")
                }
            ...
            <label className="inline-flex items-center gap-2 text-sm font-normal text-primary-color-muted">
              <input
                ...
                onChange={(event) =>
                  updateField("role", event.target.value as "admin")
                }
                className="h-4 w-4 border-secondary-color-soft text-secondary-color focus:ring-secondary-color"
              />
              Admin
